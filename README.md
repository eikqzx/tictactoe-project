This is a [Next.js 15](https://nextjs.org) project with [Joy UI](https://mui.com) with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).
